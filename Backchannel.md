...
classDiagram
    ...
    BackchannelBase o-- BackchannelTransceiver : calls WAIT_FOR_DATA_RECEIVED sendData

    BackchannelTransceiver <|-- BackchannelUDP

    BackchannelTransceiver <|-- BackchannelESPNOW
    class BackchannelESPNOW {
        uint8_t _transmitDataBuffer[512]
        uint8_t _receivedDataBuffer[256]
    }
    BackchannelESPNOW o-- ESPNOW_Transceiver
    ...
    BackchannelStabilizedVehicle o-- SV_Preferences
