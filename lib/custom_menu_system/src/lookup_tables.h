...
namespace LOOKUP_TABLES {
    ...
    constexpr std::array<const char * const, THROTTLE_LIMIT_NAMES_COUNT> throttle_limit_typeNames { "OFF", "SCALE", "CLIP" };

    enum { PID_TUNING_MODES_COUNT = 2 };
    constexpr std::array<const char * const, PID_TUNING_MODES_COUNT> _pid_tuningModes { "STANDARD", "SIMPLIFIED" };
