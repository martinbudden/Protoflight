...
static constexpr features_config_t FEATURES_CONFIG {
    .enabled_features = Features::FEATURE_RX_SERIAL | Features::FEATURE_ANTI_GRAVITY | Features::FEATURE_AIRMODE
};
...
static constexpr FlightController::default_pids_t& FLIGHT_CONTROLLER_PIDS = FlightController::DEFAULT_PIDS;
...
static constexpr tpa_config_t FLIGHT_CONTROLLER_TPA_CONFIG = {
...
#if defined(USE_DMAX)
static constexpr dmax_config_t FLIGHT_CONTROLLER_DMAX_CONFIG = {
    .dmax = { 40, 46 },
    .dmax_gain = 37,
    .dmax_advance = 20,
};
...
static constexpr rx_config_t RX_CONFIG = {
    ...
    .rssi_invert = 0,
    .rssi_offset = 0,
    .fpvCam_angle_degrees = 0,        // Camera angle to be scaled into rc commands
...
static constexpr RcAdjustments::adjustment_configs_t RC_ADJUSTMENT_CONFIGS = {{
    {
        .adjustment = ADJUSTMENT_RC_RATE,
        .mode = RcAdjustments::ADJUSTMENT_MODE_STEP,
        .data = { .step = 1 }
    }, {
        ...
        .mode = RcAdjustments::ADJUSTMENT_MODE_SELECT,
        .data = { .switch_positions = 3 }
    }, {
        ...
        .mode = RcAdjustments::ADJUSTMENT_MODE_SELECT,
        .data = { .switch_positions = 255 }
    }, {
        .adjustment = ADJUSTMENT_PID_AUDIO,
        .mode = RcAdjustments::ADJUSTMENT_MODE_SELECT,
        .data = { .switch_positions = 7 } // ARRAYLEN(pidAudioPositionToModeMap)
    }, {
...
static constexpr autopilot_config_t AUTOPILOT_CONFIG = {
    .altitude_pid = { 15, 15, 15, 0, 15 },
    .position_pid = { 30, 30, 30, 0, 30 },
    .landing_altitude_meters = 4,
...
*/
    ...
    .display_portDevice = DisplayPortBase::DEVICE_TYPE_MSP,
