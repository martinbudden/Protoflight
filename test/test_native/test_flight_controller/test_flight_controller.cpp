...
{
    TEST_ASSERT_EQUAL(Autopilot::ANGLE_MODE, 1U << Autopilot::LOG2_ANGLE_MODE);
    TEST_ASSERT_EQUAL(Autopilot::HORIZON_MODE, 1U << Autopilot::LOG2_HORIZON_MODE);
    TEST_ASSERT_EQUAL(Autopilot::MAG_MODE, 1U << Autopilot::LOG2_MAG_MODE);
    TEST_ASSERT_EQUAL(Autopilot::ALTITUDE_HOLD_MODE, 1U << Autopilot::LOG2_ALTITUDE_HOLD_MODE);
    TEST_ASSERT_EQUAL(Autopilot::GPS_HOME_MODE, 1U << Autopilot::LOG2_GPS_HOME_MODE);
    TEST_ASSERT_EQUAL(Autopilot::POSITION_HOLD_MODE, 1U << Autopilot::LOG2_POSITION_HOLD_MODE);
    TEST_ASSERT_EQUAL(Autopilot::HEADFREE_MODE, 1U << Autopilot::LOG2_HEADFREE_MODE);
    TEST_ASSERT_EQUAL(Autopilot::CHIRP_MODE, 1U << Autopilot::LOG2_CHIRP_MODE);
    TEST_ASSERT_EQUAL(Autopilot::PASSTHRU_MODE, 1U << Autopilot::LOG2_PASSTHRU_MODE);
    TEST_ASSERT_EQUAL(Autopilot::RANGEFINDER_MODE, 1U << Autopilot::LOG2_RANGEFINDER_MODE);
    TEST_ASSERT_EQUAL(Autopilot::FAILSAFE_MODE, 1U << Autopilot::LOG2_FAILSAFE_MODE);
    TEST_ASSERT_EQUAL(Autopilot::GPS_RESCUE_MODE, 1U << Autopilot::LOG2_GPS_RESCUE_MODE);
}
