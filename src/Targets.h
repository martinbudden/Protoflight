...
#define USE_GYRO_FILTERS_EXTENDED
    ...
    #define MOTOR_PINS          motor_pins_t{.m0=0xFF,.m1=0xFF,.m2=0xFF,.m3=0xFF} // BR, TR, BL, TL
    #define UART_0_PINS         rx_pins_t{.rx=1,.tx=0}
    //#define UART_0_PINS         stm32_rx_pins_t{.rx={PA,1},.tx={PA,0}}
    ...
    #define UART_0_PINS         rx_pins_t{.rx=0,.tx=0}
    ...
    #define UART_0_PINS         stm32_rx_pins_t{.rx={PA,10},.tx={PA,9}} // TX output is always inverted (for FrSky). Internally connected to USB port via CP2102 IC
    #define UART_1_PINS         stm32_rx_pins_t{.rx={PA,3},.tx={PA,2}}
    #define SOFT_SERIAL_0_PINS  stm32_rx_pins_t{.rx={PA,6},.tx={PA,7}}
    #define SOFT_SERIAL_1_PINS  stm32_rx_pins_t{.rx={PB,0},.tx={PB,1}}
    ...
    #define UART_0_PINS         stm32_rx_pins_t{.rx={PB,7},.tx={PB,6}}
    #define MOTOR_PINS          stm32_motor_pins_t{.m0={PC,7,0,0},.m1={PC,6,0,0},.m2={PB,8,0,0},.m3={PB,9,0,0}} // BR, TR, BL, TL
    ...
    #define UART_0_PINS         stm32_rx_pins_t{.rx={PA,0},.tx={PA,0}}
